...
export default function UserItem({ user, status, setSelectedUserId, setHasNotSeenMsgs }: any) {
    ...
    return (
        ...
        >
            ...
            {msgs_not_seen > 0 && <span className="absolute  md:hidden top-10 md:top-2 end-6 inline-flex items-center  py-0.5 px-2 rounded-full text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-red-500  text-white">{msgs_not_seen}</span>}
